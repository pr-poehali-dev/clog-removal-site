...
const services = [
  { icon: 'Siren', title: 'Аварийный вызов 24/7', price: 'от 1 500 ₽', desc: 'Выезжаем в любое время суток — ночью, в выходные и праздники. Мастер приедет в течение 40 минут.' },
  { icon: 'Home', title: 'Засор в квартире', price: 'от 1 500 ₽', desc: 'Прочистка засора на кухне, в ванне, раковине или унитазе. Работаем аккуратно, без грязи и запаха.' },
  { icon: 'Building2', title: 'Прочистка стояков', price: 'от 3 000 ₽', desc: 'Прочистка общедомовых стояков в многоквартирных домах. Устраняем засоры, которые затрагивают сразу несколько квартир.' },
  { icon: 'TreePine', title: 'Удаление корней', price: 'от 4 000 ₽', desc: 'Корни деревьев прорастают в стыки труб и полностью перекрывают сток. Фрезеруем корни специальными насадками.' },
  { icon: 'Truck', title: 'Откачка септиков и колодцев', price: 'договорная', desc: 'Откачка шамбо, выгребных ям и смотровых колодцев ассенизаторской машиной. Вывоз и утилизация стоков.' },
  { icon: 'ScanLine', title: 'Телеинспекция труб', price: 'от 2 500 ₽', desc: 'Видеообследование трубопровода камерой с записью на носитель. Определяем состояние труб, место и причину засора или повреждения.' },
];
