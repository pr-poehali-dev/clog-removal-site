...
const methods = [
  { icon: 'Waves', title: 'Гидродинамическая промывка', desc: 'Мощный метод очистки канализации водой под давлением до 200 бар. Специальная насадка-форсунка проталкивается внутрь трубы и интенсивной струёй воды разрушает и вымывает любые отложения: жировые пробки, ил, песок, накипь и мягкие корневые волокна. Метод безопасен для труб любого материала — чугун, пластик, керамика. Применяется при сложных и хронических засорах, а также для профилактической промывки коммуникаций в ресторанах, гостиницах и жилых домах.' },
  { icon: 'Cable', title: 'Электромеханическая прочистка', desc: 'Самая популярная услуга при прочистке засора на кухне, в ванне, раковине, унитазе и стояке — там, где не справился вантуз или ручной трос. Профессиональная машинка с металлическим тросом и сменными наконечниками проникает в трубу и быстрыми вращательными движениями устраняет засор. Справляется с зажировкой, тряпками, бумагой, влажными салфетками, кошачьим наполнителем и многим другим. Длина троса — до 50 метров.' },
  { icon: 'Video', title: 'Видеодиагностика', desc: 'Профессиональное обследование трубопровода с помощью гибкой камеры на кабеле с LED-подсветкой. Мастер в режиме реального времени видит на экране состояние трубы изнутри: точное место засора, трещины, смещение стыков, корни деревьев или посторонние предметы. Позволяет поставить точный диагноз без вскрытия стен, полов и потолков. По результатам диагностики выдаётся заключение с рекомендациями по устранению проблемы.' },
  { icon: 'Zap', title: 'Термическая промывка', desc: 'Эффективный метод борьбы с жировыми отложениями в трубах кухонной канализации. Горячая вода температурой до 90°C подаётся под давлением и растворяет затвердевший жир, который не поддаётся механической или гидродинамической обработке. Особенно востребован в ресторанах, столовых, пищевых производствах и на объектах общественного питания, где жировые пробки образуются регулярно. Рекомендуется проводить в комплексе с гидродинамической промывкой.' },
];
